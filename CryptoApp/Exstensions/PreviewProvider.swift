...
class DevPreview { // the preview example
    ...
    let stat1 = StatistickModel(title: "Market Cap", value: "$1.24Bn", percentageChange: 25.34)
    let stat3 = StatistickModel(title: "Portfolio Value", value: "$50.5k", percentageChange: -25.34)
    let stat2 = StatistickModel(title: "Total Value", value: "$14.23Tr")
